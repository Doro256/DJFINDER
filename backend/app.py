...
# # Add database
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///djs.db'
# # Initialize database
# db = SQLAlchemy(app)
# ma = Marshmallow(app)
...
# @app.route("/get_djs", methods = ['GET'])
# def get_djs():
#     all_djs = Djs.query.all()
#     results = djs_schema.dump(all_djs)
#     return jsonify(results)


# @app.route("/get_djs/<id>", methods = ['GET'])
# def get_details(id):
#     dj = Djs.query.get(id)
#     return dj_schema.jsonify(dj)
...
#     db.session.add(djs)
#     db.session.commit()
#     return dj_schema.jsonify(djs)

# @app.route("/update_djs/<id>", methods=['PUT','OPTIONS'])
...
# @app.route("/delete_djs/<id>", methods = ['DELETE'])
# def delete_djs(id):
#     dj = Djs.query.get(id)
...
class Appointment(db.Model):
    ...
    def __init__(self,first_name, last_name, comments, date_time_from, date_time_to):
